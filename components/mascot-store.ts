...
export const MASCOT_LINES: MascotLine[] = [
  ...
  { pose: "baby-mo-pose-03", text: { id: "Yuk baca doa hari ini 🤲", en: "Let's read today's du'a 🤲" } },
  ...
  { pose: "baby-mo-pose-12", text: { id: "Hari yang berkah ✨", en: "A blessed day ✨" } },
  ...
  { pose: "baby-mo-pose-27", text: { id: "Ayo hafal surat pendek 📖", en: "Let's memorize a short surah 📖" } },
