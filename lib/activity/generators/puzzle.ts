// Simple Puzzle worksheet: a "cut & paste" jigsaw. We draw an empty NxN target
// grid; below it, the same pieces are scrambled and numbered. The child cuts the
// bottom pieces out and arranges them into the empty grid above.
