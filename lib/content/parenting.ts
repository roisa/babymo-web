...
export const parentingList: ParentingSituation[] = [
  ...
  },
  {
    ...
    recommendedDoa: ["sebelum-tidur", "bangun-tidur"],
  ...
  },
  {
    ...
    recommendedDoa: ["sebelum-makan", "sesudah-makan", "masuk-kamar-mandi", "keluar-kamar-mandi"],
  ...
  },
  {
    ...
    recommendedDoa: ["sesudah-makan", "bangun-tidur"],
    supportingHadith: ["muliakan-anak"],
    ageMin: 3,
    ageMax: 10,
    category: "spiritual",
